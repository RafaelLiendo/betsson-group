        ...
        public static void Populate(DbContext context)
        {
            ...
            var movies = new Movie[]
            {
                new Movie()
                {
                    ...
                    Genres= genres.FindByKey("action", "adventure", "comedy").ToMovieGenre(),
                    Rate= "8.6",
                    Length= "1hr 48mins",
                    Img= "deadpool.jpg"
                },
                new Movie()
                {
                    ...
                    Genres= genres.FindByKey("adventure", "comedy", "crime").ToMovieGenre(),
                    Rate= "7.0",
                    Length= "1hr 50mins",
                ...
                new Movie()
                {
                    ...
                    Genres= genres.FindByKey("biography", "drama", "history").ToMovieGenre(),
                    Rate= "8.0",
                    Length= "2hr 27mins",
                ...
                new Movie()
                {
                    ...
                    Genres= genres.FindByKey("crime", "drama", "sport").ToMovieGenre(),
                    Rate= "6.9",
                    Length= "2hr 5mins",
                ...
                new Movie()
                {
                    ...
                    Genres= genres.FindByKey("biography", "crime", "drama").ToMovieGenre(),
                    Rate= "7.8",
                    Length= "2hr 37mins",
                ...
                new Movie()
                {
                    ...
                    Genres= genres.FindByKey("action", "crime", "drama").ToMovieGenre(),
                    Rate= "6.8",
                    Length= "1hr 53mins",
                ...
                new Movie()
                {
                    ...
                    Genres= genres.FindByKey("crime", "mystery", "thriller").ToMovieGenre(),
                    Rate= "7.3",
                    Length= "1hr 55mins",
                ...
                new Movie()
                {
                    ...
                    Genres= genres.FindByKey("action", "adventure", "scifi").ToMovieGenre(),
                    Rate= "7.1",
                    Length= "2hr 4mins",
                ...
                new Movie()
                {
                    ...
                    Genres= genres.FindByKey("action", "adventure", "thriller").ToMovieGenre(),
                    Rate= "7.5",
                    Length= "2hr 11mins",
                ...
                new Movie()
                {
                    ...
                    Genres= genres.FindByKey("action", "drama", "sport").ToMovieGenre(),
                    Rate= "7.5",
                    Length= "2hr 4mins",
                    Img= "southpaw.jpg"
                },
                new Movie()
                {
                    ...
                    Genres= genres.FindByKey("biography", "drama", "thriller").ToMovieGenre(),
                    Rate= "7.7",
                    Length= "2hr 22mins",
                ...
                new Movie()
                {
                    ...
                    Genres= genres.FindByKey("action", "crime", "thriller").ToMovieGenre(),
                    Rate= "7.3",
                    Length= "2hr 17mins",
                ...
                new Movie()
                {
                    ...
                    Genres= genres.FindByKey("comedy").ToMovieGenre(),
                    Rate= "7.8",
                    Length= "1hr 40mins",
                ...
                new Movie()
                {
                    ...
                    Genres= genres.FindByKey("comedy", "crime").ToMovieGenre(),
                    Rate= "6.7",
                    Length= "1hr 28mins",
                    Img= "project-x.jpg"
                },
                ...
                new Movie()
                {
                    ...
                    Genres= genres.FindByKey("action", "thriller").ToMovieGenre(),
                    Rate= "6.1",
                    Length= "1hr 35mins",
                ...
                new Movie()
                {
                    ...
                    Genres= genres.FindByKey("action", "scifi").ToMovieGenre(),
                    Rate= "8.7",
                    Length= "2hr 16mins",
                    Img= "the-matrix.jpg"
                },
                new Movie()
                {
                    ...
                    Genres= genres.FindByKey("action", "comedy", "crime").ToMovieGenre(),
                    Rate= "6.8",
                    Length= "1hr 59mins",
                    Img= "bad-boys.jpg"
                }
